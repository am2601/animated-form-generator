...
export default function Page() {
  ...
  const htmlCode = `<link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,600,700" rel="stylesheet">
  <form>
  ...
  return (
    <div className="flex h-screen p-6 pt-16">
      ...
      <div className="w-80 ml-4 bg-white shadow-md rounded-lg p-6">
        ...
        <div className="mt-10 p-2 text-lg text-gray-500">Original source: <a href="https://github.com/Alisherka7/Animated-login-form-Avatar.github.io" target="_blank" className="text-blue-500 underline">Github</a></div>
      </div>
    </div>
  );
}
