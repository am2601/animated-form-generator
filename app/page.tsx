            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-5xl text-center">
                ...
                <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
                  Quickly generate login forms with animated characters. Completely for free.
                </p>
                <div className="mt-14 flex items-center justify-center gap-x-6">
                  <Link
                    href="/app"
                    className="rounded-md bg-indigo-600 px-7 py-4 text-2xl font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  >
                    Get started
                  </Link>
                </div>
